...
const ModalSharePost = (props) => {
  ...
  return (
    <>
      <Modal
        className="bg-base-300 p-3 w-1/2 lg:w-1/3 rounded space-y-3"
        open={props.visible}
      ...
      >
        ...
        <div className="input-group border rounded-lg">
          <input
            ...
            readonly
          />
          <button type="button" className="bg-base-200" onClick={copyToClipboard}>
            <AiFillCopy className="w-10 "/>
          </button>
        </div>
        {/* <div className="flex h-3 relative -top-3 italic text-xs">
