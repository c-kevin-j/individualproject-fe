        ...
        <div className="navbar">
          ...
          <div className="flex-none gap-2">
            ...
            <div className="space-x-2">
              <button type="button" className="btn btn-sm btn-secondary w-24" onClick={()=>router.push("/auth/login")}>
                Login
              </button>
              <button type="button" className="btn btn-sm btn-accent w-24" onClick={()=>router.push("/auth/register")}>
                Register
              </button>
            </div>
